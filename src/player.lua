...
function player:load()
	...
	player_images = {}
	player_images.front = love.graphics.newImage("assets/img/pc_front_130px.png")
	player_images.right = love.graphics.newImage("assets/img/pc_right_130px.png")
	player_images.left  = love.graphics.newImage("assets/img/pc_left_130px.png")
	player_images.back  = love.graphics.newImage("assets/img/pc_front_130px.png")
